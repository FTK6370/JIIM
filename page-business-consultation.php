...
<body>
    ...
    <!-- Page Business Consultation Start -->
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                <h1 class="display-5"><?php echo $lang["Business Consulting"]?></h1>
                <hr class="w-25 mx-auto text-primary" style="opacity: 1;">
            </div>
            <p class="fs-4 fw-normal text-dark text-center"><?php echo $lang["In addition to consulting related to the above two pillars, we will also provide various consultations and advice making full use of the experience and personal connections we have cultivated in Indonesia."]?></p><br>
            <p class="fs-4 fw-normal text-dark text-center"><?php echo $lang["Stay tuned for our ongoing projects with these companies."]?></p>
        </div>
    </div>
    <!-- Page Business Consultation Ends -->
