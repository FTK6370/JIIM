    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                <h1 class="display-5"><?php echo $lang["Collaboration with SMEs"]?></h1>
                <hr class="w-25 mx-auto text-primary" style="opacity: 1;">
            </div>
            <p class="fs-4 fw-normal text-dark text-center"><?php echo $lang["We aim to grow together with Indonesian small & medium-sized enterprises, or university-launched startups by investing in these companies."]?></p><br>
            <p class="fs-4 fw-normal text-dark text-center"><?php echo $lang["Stay tuned for our ongoing projects with these companies."]?></p><br>
        </div>
    </div>
