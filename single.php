...
<body>
    ...
    <br>
    <div class="row">
        <div class="col-9" style="max-width: 60%; margin-left: 5%;">
            <h3 class="mt-5"><?php the_title(); ?></h3>
            <small class="text">Posted by jiim_admin</small><br><br>
            ...
            <p class="fs-4 fw-normal text-dark"><?php the_content(); ?></p>
        </div>
    ...
    <!-- News End -->
        ...
        <div class="col-3 text-light">
            <aside id="sidebar">
            <p class="fs-4 fw-normal text-light">
                <?php get_sidebar(); ?></p>
            </aside>
        </div>
    </div>
